...
<div class="row mt-md-5 mt-3">
    <h1 class="col-md text-center" id="services-container"> Реєстрація </h1>
</div>
...
<section class="container my-md-5 my-3">
    <div class="row  align-items-center">
        <div class="col-md-3 d-none d-md-block">
            <div class="row justify-content-end">
                ...
                <form method="post" action="register.php">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="username" placeholder="Введіть Логін"><br>
                    </div>
                    <div class="input-group">
                        <label>Email</label>
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" name="password_1" placeholder="Введіть пароль"><br>
                    </div>
                    <div class="input-group">
                    ...
                    <p>
                        Вже зареєстровані? <a href="#contact-conatiner">Вхід</a>
                    </p>
                </form>
         ...
         }else if(isset($_POST['send']) && !empty($_POST['username']) && !empty($_POST['email']) && !empty($_POST['password_1'])){
    ...
    $query="insert into users(username,email,password_1) VALUES ('$username','$email','$password1')";

    mysqli_query($db,$query) or die("error query");

    echo"Акаунт доданий успішно!<a href='register.php'>Додати ще</a>";
         }
